...
<head>
    ...
    <meta name="author" content="Partner Login" />

    <link rel="icon" href="public/images/fav.png" type="image/x-icon" />
    <title>Partner Signup</title>
    <?php include "main_link_css.php";?>
    <link rel="stylesheet" href="public/css/partner-style.css">
</head>  

<body>

    <?php include "header.php";?>
    <div class="backg-bg" style="background-image:url('public/images/img16.jpg');">
        <div class="login-box-in">
            <div class="left-b" style="background-image:url('public/images/partner.jpg');">
                <h1>Parnter <span>Signup</span></h1>
            </div>
            <div class="right-b">
                <div class="user-in">
                    <img src="public/images/profile.png" class="img-fluid">
                </div>
                <!-- <h3>Login Now</h3> -->
                <form>
