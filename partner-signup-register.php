...
<head>
    ...
    <meta name="keywords" content="Sign-up as Partner" />
    <meta name="description" content="Sign-up as Partner" />
    <meta name="author" content="Sign-up as Partner" />

    <link rel="icon" href="public/images/fav.png" type="image/x-icon" />
    <title>Sign-up as Partner</title>
    <?php include "main_link_css.php";?>
    <link rel="stylesheet" href="public/css/signup-partner2-style.css">
</head>
...
<body>
    ...
    <div class="backg-bg" style="background-image:url('public/images/abstract-blur-defocused-shopping-mall0.jpg');">
        <div class="login-box-in">
            <div class="left-b" style="background-image:url('public/images/handshake-close-up-executives.jpg');">
                <h1>Sign-up as Partner</h1>
            </div>

            <div class="right-b">
                <div class="user-in">
                    <img src="public/images/boss.png" class="img-fluid">
                </div>
                <!-- <h3>Login Now</h3> -->
                <form>
